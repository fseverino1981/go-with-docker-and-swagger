...
// GeneralToken mocks base method.
func (m *MockUserDomainInterface) GeneralToken() (string, *rest_err.RestErr) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GeneralToken")
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(*rest_err.RestErr)
	return ret0, ret1
}

// GeneralToken indicates an expected call of GeneralToken.
func (mr *MockUserDomainInterfaceMockRecorder) GeneralToken() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GeneralToken", reflect.TypeOf((*MockUserDomainInterface)(nil).GeneralToken))
}
